...
action() {
  ...
  local custom="--customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_3000,Configuration/DataProcessing/Utils.addMonitoring,SimCalorimetry/HGCalSimProducers/hgcalDigitizer_cfi.HGCal_setBxMinOneThreshold_2"
