...
#
# runTheMatrix.py -w upgrade -l 27434.11 --command="--no_exec" --dryRun
#
...
cmsDriver.py TTbar_14TeV_TuneCUETP8M1_cfi  --conditions auto:phase2_realistic \
  -n 10 --era Phase2C4_timing_layer_bar --eventcontent FEVTDEBUGHLT --nThreads 4 \
...
cmsDriver.py step3  --conditions auto:phase2_realistic -n 10 \
  --era Phase2C4_timing_layer_bar --eventcontent FEVTDEBUGHLT,DQM --runUnscheduled --nThreads 4 \
  -s RAW2DIGI,L1Reco,RECO,RECOSIM,VALIDATION:@phase2Validation,DQM:@phase2 \
  --datatier GEN-SIM-RECO,DQMIO --geometry Extended2023D35 \
  --no_exec --python_filename=RECO_fragment.py


cmsDriver.py step3 --conditions auto:phase2_realistic -n 10 \
  --era Phase2C4_timing_layer_bar --eventcontent FEVTDEBUGHLT --runUnscheduled \
  -s RAW2DIGI,L1Reco,RECO,RECOSIM \
  --datatier GEN-SIM-RECO --geometry Extended2023D35 \
