...
#
# runTheMatrix.py -w upgrade -j 0 -l 27434.11 --command="--no_exec" --dryRun
#
...
cmsDriver.py TTbar_14TeV_TuneCUETP8M1_cfi  --conditions auto:phase2_realistic \
  -n 10 --era Phase2C4_timing_layer_bar --eventcontent FEVTDEBUGHLT \
...
cmsDriver.py step3  --conditions auto:phase2_realistic -n 10 \
  --era Phase2C4_timing_layer_bar --eventcontent FEVTDEBUGHLT,DQM --runUnscheduled \
