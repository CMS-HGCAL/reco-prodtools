...
action() {
  ...
  local custom="--customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_3000,SimCalorimetry/HGCalSimProducers/hgcalDigitizer_cfi.HGCal_ignorePulsePerGain,Configuration/DataProcessing/Utils.addMonitoring"
